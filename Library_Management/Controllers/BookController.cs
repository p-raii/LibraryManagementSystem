...
namespace Library_Management.Controllers
{
    public class BookController : Controller
    {
        ...
        public BookController(Library_ManagementContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,CategoryId,Avability,BookPhoto")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
